            ...
            if isMenuActive("modMenu") then
                if currentCategory == 18 then --Turbo
                    if AttemptPurchase("turbo", currentMenuItemID) then
                        ...
                        local price = vehicleCustomisationPrices["performance"].prices[currentMenuItemID+2]
                        mechanicLogs.message = mechanicLogs.message.."\n".."Turbo".." Level ".. currentMenuItemID + 1 .. " - $"..price
                ...
                elseif currentCategory == 11 or currentCategory == 12 or currentCategory == 13 or currentCategory == 15 or currentCategory == 16 then --Performance Upgrades
                    if AttemptPurchase("performance", currentMenuItemID) then
                        local price = vehicleCustomisationPrices["performance"].prices[currentMenuItemID+2]
                        mechanicLogs.price = mechanicLogs.price + price
                        if currentCategory == 11 then
                            mechanicLogs.message = mechanicLogs.message.."\n".."Engine".." Level ".. currentMenuItemID + 1 .. " - $"..price
                        elseif currentCategory == 12 then
                            mechanicLogs.message = mechanicLogs.message.."\n".."Brake".." Level ".. currentMenuItemID + 1 .. " - $"..price
                        elseif currentCategory == 13 then
                            mechanicLogs.message = mechanicLogs.message.."\n".."Transmission".." Level ".. currentMenuItemID + 1 .. " - $"..price
                        elseif currentCategory == 15 then
                            mechanicLogs.message = mechanicLogs.message.."\n".."Suspension".." Level ".. currentMenuItemID + 1 .. " - $"..price
                        elseif currentCategory == 16 then
                            mechanicLogs.message = mechanicLogs.message.."\n".."Armour".." Level ".. currentMenuItemID + 1 .. " - $"..price
                        end
                        ApplyMod(currentCategory, currentMenuItemID)
                        playSoundEffect("wrench", 0.4)
                        updateItem2Text(currentMenu, currentMenuItemID, "Installed")
